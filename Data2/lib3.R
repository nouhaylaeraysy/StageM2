...
# Load the data 
lib3.data <- Read10X("/home/yanis/Bureau/Finale/filtered_feature_bc_matrix_larva3_virilis/")
...
lib3 <- RunPCA(object = lib3 , npcs =  100)
ElbowPlot(lib3 , ndims = 100)
lib3
...
DimPlot(lib3, reduction = 'umap', group.by = "DF.classifications_0.25_0.3_1735")
dev.off()
...
table(lib3@meta.data$DF.classifications_0.25_0.3_1735)
#Doublet Singlet 
#1735   14126 

object_NoDoublets <- subset(lib3, subset =  DF.classifications_0.25_0.3_1735== "Singlet")
object_NoDoublets
