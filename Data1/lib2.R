...
# Load the data 
lib2.data <- Read10X("/home/yanis/Bureau/Finale/Data1/larval2//filtered_feature_bc_matrix/")
...
lib2 <- RunPCA(object = lib2 )
lib2
ElbowPlot(lib2 , ndims = 50)
...
DimPlot(lib2, reduction = 'umap', group.by = "DF.classifications_0.25_0.3_1684")
dev.off()
pdf("dpn_distrubutionlib2.pdf")
FeaturePlot(lib2 , features = "LOC6627282")
dev.off()
# number of singlets and doublets
table(lib2@meta.data$DF.classifications_0.25_0.3_1684)
#Doublet Singlet 
#1684   13600 

object_NoDoublets <- subset(lib2, subset =  DF.classifications_0.25_0.3_1684== "Singlet")
object_NoDoublets
